...
public class CurrencyRepository {
    ...
    public static Set<Currency> allCurrencies() {
        ...
        // 11. IOTA
        currencies.add(new Currency("iota", "IOTA",  "MIOTA", 11, 1.79426, 0.00021851,
                64937100.0, 4987200006.0,2779530283.0,2779530283.0,2779530283.0,
                -3.3,-7.35,-8.91,1518296950));
